...
# 📝 ለውጥ፦ v1.10 Optimized Build Script — PostgreSQL Ultra Index Safeguard (v1.10)
# ✅ የተፈቱ ችግሮች፦ relation marketplace_predict_24e4bf_idx already exists (Postgres final-index migration fixed!)
# 📅 ቀን፦ 2026-06-25
# ============================================================
...
with connection.cursor() as cursor:
    ...
    cursor.execute('DROP INDEX IF EXISTS marketplace_predict_24e4bf_idx;')
    ...
    cursor.execute('CREATE INDEX IF NOT EXISTS marketplace_predicti_9ce3e9_idx ON marketplace_predictionlog (prediction_type, site_id);')
